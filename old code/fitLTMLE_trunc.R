...
#
#
fitLTMLE_trunc <- function(data, # data table or data frame 
                     ...
                     QLlearner = NULL,
                     Clearner = NULL,
                     alpha = 0.005 # truncation (alpha, 1-alpha) used to bound Q_L away from 1 and 0
 ...
 min.a1.ga1 <- min(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a1.ga1")]])
 max.a1.ga1 <- max(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a1.ga1")]])
 min.a1.ga0 <- min(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a1.ga0")]])
 max.a1.ga0 <- max(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a1.ga0")]])
 min.a0.ga0 <- min(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a0.ga0")]])
 max.a0.ga0 <- max(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a0.ga0")]])
 if(max.a1.ga1 > 1){
   set(data, i = which(data[[Cnodes[K]]]==0), j = paste0("QM_", K, ".a1.ga1_trunc"), value =(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a1.ga1")]] - min.a1.ga1)/(max.a1.ga1-min.a1.ga1))
 }
 else{
   set(data, i = which(data[[Cnodes[K]]]==0), j = paste0("QM_", K, ".a1.ga1_trunc"), value =(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a1.ga1")]]))
 }
 if(max.a1.ga0 > 1){
   set(data, i = which(data[[Cnodes[K]]]==0), j = paste0("QM_", K, ".a1.ga0_trunc"), value =(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a1.ga0")]] - min.a1.ga0)/(max.a1.ga0-min.a1.ga0))
 }
 else{
   set(data, i = which(data[[Cnodes[K]]]==0), j = paste0("QM_", K, ".a1.ga0_trunc"), value =(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a1.ga0")]]))
 }
 if(max.a0.ga0 > 1){
   set(data, i = which(data[[Cnodes[K]]]==0), j = paste0("QM_", K, ".a0.ga0_trunc"), value =(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a0.ga0")]] - min.a0.ga0)/(max.a0.ga0-min.a0.ga0))
 } 
 else{
   set(data, i = which(data[[Cnodes[K]]]==0), j = paste0("QM_", K, ".a0.ga0_trunc"), value =(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K, ".a0.ga0")]]))
 }
 ...
 for(k in 1:(K-1)){
   ...
   fitL.a1.ga1 <- lrn_QL$train(make_task(data[data[[Cnodes[K-k+1]]]==0,], 
                                         paste0("QM_",K-k+1, ".a1.ga1_trunc~",QLcov[K-k+1])))
   fitL.a1.ga0 <- lrn_QL$train(make_task(data[data[[Cnodes[K-k+1]]]==0,], 
                                         paste0("QM_",K-k+1, ".a1.ga0_trunc~",QLcov[K-k+1])))
   fitL.a0.ga0 <- lrn_QL$train(make_task(data[data[[Cnodes[K-k+1]]]==0,], 
                                         paste0("QM_",K-k+1, ".a0.ga0_trunc~",QLcov[K-k+1])))
   
   # initial predictions QL_k+1
   newcols <- c(paste0("QM_",K-k+1, ".a1.ga1_trunc"), paste0("QM_",K-k+1, ".a1.ga0_trunc"), paste0("QM_",K-k+1, ".a0.ga0_trunc"))
   ...
   # target QL_k+1
   eps.a1.ga1 <- coef(glm.fit(x = rep(1, nrow(data[data[[Cnodes[K-k+1]]]==0,])), y = data[data[[Cnodes[K-k+1]]]==0,][[paste0("QM_",K-k+1, ".a1.ga1_trunc")]], 
                              weights = data[data[[Cnodes[K-k+1]]]==0,][[paste0("H.a1.ga1.", K-k+1)]], offset = qlogis(QL.a1.ga1), 
                              family = quasibinomial()))
   
   eps.a1.ga0 <- coef(glm.fit(x = rep(1, nrow(data[data[[Cnodes[K-k+1]]]==0,])), y = data[data[[Cnodes[K-k+1]]]==0,][[paste0("QM_",K-k+1, ".a1.ga0_trunc")]], 
                              weights = data[data[[Cnodes[K-k+1]]]==0,][[paste0("H.a1.ga0.", K-k+1)]], offset = qlogis(QL.a1.ga0), 
                              family = quasibinomial()))
   
   eps.a0.ga0 <- coef(glm.fit(x = rep(1, nrow(data[data[[Cnodes[K-k+1]]]==0,])), y = data[data[[Cnodes[K-k+1]]]==0,][[paste0("QM_",K-k+1, ".a0.ga0_trunc")]], 
                              weights = data[data[[Cnodes[K-k+1]]]==0,][[paste0("H.a0.ga0.",K-k+1)]], offset = qlogis(QL.a0.ga0), 
                              family = quasibinomial()))
   
   data[data[[Cnodes[K-k+1]]]==0, paste0("QL_", K-k+1, ".a1.ga1.star"):= (max.a1.ga1 - min.a1.ga1)*plogis(qlogis(QL.a1.ga1) + eps.a1.ga1) + min.a1.ga1]
   data[data[[Cnodes[K-k+1]]]==0, paste0("QL_", K-k+1, ".a1.ga0.star"):= (max.a1.ga1 - min.a1.ga1)*plogis(qlogis(QL.a1.ga0) + eps.a1.ga0) + min.a1.ga0]
   data[data[[Cnodes[K-k+1]]]==0, paste0("QL_", K-k+1, ".a0.ga0.star"):= (max.a0.ga0 - min.a0.ga0)*plogis(qlogis(QL.a0.ga0) + eps.a0.ga0) + min.a0.ga0]
   ...
   for(i in 1:(n_bins-1)){
     ...
     set(data, i = which(data[[Cnodes[K-k]]]==0), j = paste0("QM_", K-k, ".a1.ga1"), value = data[data[[Cnodes[K-k]]]==0, ][[paste0("QM_", K-k, ".a1.ga1")]] + 
           ((max.a1.ga1 - min.a1.ga1)*plogis(qlogis(QL.a1.ga1) + eps.a1.ga1) + min.a1.ga1)*g.a1*diff(m_k_discrete)[i])
     set(data, i = which(data[[Cnodes[K-k]]]==0), j = paste0("QM_", K-k, ".a1.ga0"), value = data[data[[Cnodes[K-k]]]==0, ][[paste0("QM_", K-k, ".a1.ga0")]] + 
           ((max.a1.ga0 - min.a1.ga0)*plogis(qlogis(QL.a1.ga0) + eps.a1.ga0) + min.a1.ga0)*g.a0*diff(m_k_discrete)[i])
     set(data, i = which(data[[Cnodes[K-k]]]==0), j = paste0("QM_", K-k, ".a0.ga0"), value = data[data[[Cnodes[K-k]]]==0, ][[paste0("QM_", K-k, ".a0.ga0")]] + 
           ((max.a0.ga0 - min.a0.ga0)*plogis(qlogis(QL.a0.ga0) + eps.a0.ga0) + min.a1.ga0)*g.a0*diff(m_k_discrete)[i])
     
   }
   
   min.a1.ga1 <- min(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K-k, ".a1.ga1")]])
   max.a1.ga1 <- max(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K-k, ".a1.ga1")]])
   min.a1.ga0 <- min(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K-k, ".a1.ga0")]])
   max.a1.ga0 <- max(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K-k, ".a1.ga0")]])
   min.a0.ga0 <- min(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K-k, ".a0.ga0")]])
   max.a0.ga0 <- max(data[data[[Cnodes[K]]]==0, ][[paste0("QM_", K-k, ".a0.ga0")]])
   if(max.a1.ga1 >1){
     set(data, i = which(data[[Cnodes[K-k]]]==0), j = paste0("QM_", K-k, ".a1.ga1_trunc"), value = (data[data[[Cnodes[K-k]]]==0, ][[paste0("QM_", K-k, ".a1.ga1")]]- min.a1.ga1)/(max.a1.ga1-min.a1.ga1))
   }
   else{
     set(data, i = which(data[[Cnodes[K-k]]]==0), j = paste0("QM_", K-k, ".a1.ga1_trunc"), value = (data[data[[Cnodes[K-k]]]==0, ][[paste0("QM_", K-k, ".a1.ga1")]]))
   }
   if(max.a1.ga0 > 1){
     set(data, i = which(data[[Cnodes[K-k]]]==0), j = paste0("QM_", K-k, ".a1.ga0_trunc"), value = (data[data[[Cnodes[K-k]]]==0, ][[paste0("QM_", K-k, ".a1.ga0")]]- min.a1.ga0)/(max.a1.ga0-min.a1.ga0))
   }
   else{
     set(data, i = which(data[[Cnodes[K-k]]]==0), j = paste0("QM_", K-k, ".a1.ga0_trunc"), value = (data[data[[Cnodes[K-k]]]==0, ][[paste0("QM_", K-k, ".a1.ga0")]]))
   }
   if(max.a0.ga0 > 1){
     set(data, i = which(data[[Cnodes[K-k]]]==0), j = paste0("QM_", K-k, ".a0.ga0_trunc"), value = (data[data[[Cnodes[K-k]]]==0, ][[paste0("QM_", K-k, ".a0.ga0")]]- min.a0.ga0)/(max.a0.ga0-min.a0.ga0))
     
   }
   else{
     set(data, i = which(data[[Cnodes[K-k]]]==0), j = paste0("QM_", K-k, ".a0.ga0_trunc"), value = (data[data[[Cnodes[K-k]]]==0, ][[paste0("QM_", K-k, ".a0.ga0")]]))
 ...
 # fit initial QL_1
 fitL.a1.ga1 <- lrn_QL$train(make_task(data[data[[Cnodes[1]]]==0,], paste0("QM_1.a1.ga1_trunc", "~",QLcov[1])))
 fitL.a1.ga0 <- lrn_QL$train(make_task(data[data[[Cnodes[1]]]==0,], paste0("QM_1.a1.ga0_trunc", "~",QLcov[1])))
 fitL.a0.ga0 <- lrn_QL$train(make_task(data[data[[Cnodes[1]]]==0,], paste0("QM_1.a0.ga0_trunc", "~",QLcov[1])))
 
 # initial predictions QL_1
 newcols <- c("QM_1.a1.ga1_trunc", "QM_1.a1.ga0_trunc", "QM_1.a0.ga0_trunc")
 nd.a1 <- cbind(nd.a1, data[,..newcols])
 nd.a0 <- cbind(nd.a0, data[,..newcols])
 QL1.a1.ga1 <- pmin(1-alpha, pmax(alpha, fitL.a1.ga1$predict(make_task(nd.a1[nd.a1[[Cnodes[1]]]==0,], 
                                         paste0("QM_1.a1.ga1_trunc", "~",QLcov[1])))))
 QL1.a1.ga0 <- pmin(1-alpha, pmax(alpha, fitL.a1.ga0$predict(make_task(nd.a1[nd.a1[[Cnodes[1]]]==0,], 
                                         paste0("QM_1.a1.ga0_trunc", "~",QLcov[1])))))
 QL1.a0.ga0 <- pmin(1-alpha, pmax(alpha, fitL.a0.ga0$predict(make_task(nd.a0[nd.a0[[Cnodes[1]]]==0,], 
                                         paste0("QM_1.a0.ga0_trunc", "~",QLcov[1])))))
 
 # target QL_1
 eps.a1.ga1 <- coef(glm.fit(x = rep(1, nrow(data[data[[Cnodes[1]]]==0,])), y = data[data[[Cnodes[1]]]==0,][["QM_1.a1.ga1_trunc"]], 
                            weights = data[data[[Cnodes[1]]]==0,][[paste0("H.a1.ga1.", 1)]], offset = qlogis(QL1.a1.ga1), 
                            family = quasibinomial()))
 eps.a1.ga0 <- coef(glm.fit(x = rep(1, nrow(data[data[[Cnodes[1]]]==0,])), y = data[data[[Cnodes[1]]]==0,][["QM_1.a1.ga0_trunc"]], 
                            weights = data[data[[Cnodes[1]]]==0,][[paste0("H.a1.ga0.", 1)]], offset = qlogis(QL1.a1.ga0), 
                            family = quasibinomial()))
 eps.a0.ga0 <- coef(glm.fit(x = rep(1, nrow(data[data[[Cnodes[1]]]==0,])), y = data[data[[Cnodes[1]]]==0,][["QM_1.a0.ga0_trunc"]], 
                            weights = data[data[[Cnodes[1]]]==0,][[paste0("H.a0.ga0.", 1)]], offset = qlogis(QL1.a0.ga0), 
                            family = quasibinomial()))
 
 set(data, i=which(data[[Cnodes[1]]]==0), j="QL_1.a1.ga1.star", value=(max.a1.ga1 - min.a1.ga1)*plogis(qlogis(QL1.a1.ga1) + eps.a1.ga1) + min.a1.ga1)
 set(data, i=which(data[[Cnodes[1]]]==0), j="QL_1.a1.ga0.star", value=(max.a1.ga0 - min.a1.ga0)*plogis(qlogis(QL1.a1.ga0) + eps.a1.ga0) + min.a1.ga0)
 set(data, i=which(data[[Cnodes[1]]]==0), j="QL_1.a0.ga0.star", value=(max.a0.ga0 - min.a0.ga0)*plogis(qlogis(QL1.a0.ga0) + eps.a0.ga0) + min.a1.ga0)
